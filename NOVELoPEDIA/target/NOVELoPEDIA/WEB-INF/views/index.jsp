...
================================================== -->
	...
	<!-- /.carousel -->
	<hr />
	<img class="img-rounded" class="image-responsive center-block"
				src="<spring:url value="/resources/image4.jpg"></spring:url>"
				style="width: 20%; height: 60%;"> 
				<img class="img-rounded"
				class="image-responsive center-block"
				src="<spring:url value="/resources/image5.jpg"></spring:url>"
				style="width: 20%; height: 60%;"> 
				<img class="img-rounded"
				class="image-responsive center-block"
				src="<spring:url value="/resources/image6.jpg"></spring:url>"
				style="width: 20%; height: 60%;">
